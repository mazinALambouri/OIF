    ...
    <section id="about" className="py-24 bg-gradient-to-br from-white via-gray-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 relative z-10">
        <div className="text-center mb-8 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2 mb-4">About the Forum</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-16 items-center">
          <div className="space-y-4 sm:space-y-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-2xl p-4 sm:p-8 shadow-xl">
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                The Oman Investment Forum 2025 is a premier gathering of global investors, industry leaders, and policymakers. This landmark event showcases Oman's emerging opportunities across various sectors including technology, renewable energy, tourism, and manufacturing.
              </p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-2xl p-4 sm:p-8 shadow-xl">
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                Join us for three days of insightful discussions, networking opportunities, and firsthand exposure to Oman's most promising investment prospects. Experience how Oman is positioning itself as a strategic hub for international business and innovation.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3 sm:gap-8">
              <div className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-2xl p-3 sm:p-6 shadow-xl transform hover:scale-105 transition-transform duration-300">
                <div className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">500+</div>
          ...
          <div className="relative group mt-6 md:mt-0">
            ...
            <div className="absolute -bottom-2 sm:-bottom-8 -right-2 sm:-right-8 bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-3 sm:p-6 rounded-lg sm:rounded-2xl shadow-xl transform group-hover:translate-x-4 group-hover:-translate-y-4 transition-transform duration-300">
              <div className="text-lg sm:text-3xl font-bold">March 27-29</div>
              <div className="text-white/90 text-xs sm:text-base">2025</div>
            </div>
          </div>
        </div>
      </div>
